...
//    		if(debugging)
		...
		Intent intent4P = new Intent(getBaseContext(), WF.class);
		// How to pass this to NotifyMessage -> Need flag on PI!!!!
		intent4P.putExtra("Notify at", sdfTime.format(new Date()));
...
//		mgr.notify(NOTIFY_ME_ID, note);
    ...
    //=================================================================
	// ???? How can this method get to GUI on SWS
