    ...
    public String getDescription() {
        ...
        if ((flags & FLAG_SD) != 0) {
            if (isInteresting(label)) {
                return "Test test haha disk info";/*res.getString(R.string.storage_sd_card_label, label);*/
            } else {
                return "Test test else disk info" /*res.getString(R.string.storage_sd_card)*/;
            }
