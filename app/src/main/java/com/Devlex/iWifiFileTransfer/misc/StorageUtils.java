...
import static com.Devlex.iWifiFileTransfer.misc.DiskInfo.FLAG_SD;
import static com.Devlex.iWifiFileTransfer.misc.DiskInfo.FLAG_USB;
...
public final class StorageUtils {
    ...
    public List<VolumeInfo> getVolumes() {
        ...
        Log.w(TAG, "TOG list  volume infomounts: " + mounts);
    ...
    public List<StorageVolume> getStorageMounts() {
        ...
        for (Object object : sv) {
            ...
            Log.w(TAG, "TOG storageVolume inside: " + storageVolume);
        ...
        Log.w(TAG, "TOG storageVolume: " + mounts);
    ...
    private DiskInfo getDiskInfo(Object object) {
        ...
        Log.w(TAG, "TOG diskInfo: " + diskInfo);
        ...
        if (vol.disk != null) {
            ...
            if ((flags & FLAG_SD) != 0) {
                if (vol.disk.isInteresting(label)) {
                    return "Test test haha";/*res.getString(R.string.storage_sd_card_label, label);*/
                } else {
                    return "Test test" /*res.getString(R.string.storage_sd_card)*/;
                }
