...
public class Utils {
    ...
    public static boolean isBuild(){
        return BuildConfig.FLAVOR.contains("");
    }
    ...
    public static Uri getAppShareUri(){
        if(isBuild()){
            return Uri.parse("https://www..com/gp/mas/dl/android?p=" + BuildConfig.APPLICATION_ID);
        }
    ...
    public static Uri getAppStoreUri(){
        if(isBuild()){
            return Uri.parse("http://www..com/gp/mas/dl/android?p=" + BuildConfig.APPLICATION_ID + "&showAll=1");
        }
    ...
    public static void openFeedback(Activity activity){
        ShareCompat.IntentBuilder
                ...
                .setSubject("Wifi File Transfer Feedback" + getSuffix())
                .setType("text/email")
