...
import com.Devlex.iWifiFileTransfer.misc.ContentProviderClientCompat;
import com.Devlex.iWifiFileTransfer.CrashReportingManager;
import com.Devlex.iWifiFileTransfer.misc.OsCompat;
import com.Devlex.iWifiFileTransfer.misc.Utils;
import com.Devlex.iWifiFileTransfer.provider.DocumentsProvider;

import static com.Devlex.iWifiFileTransfer.misc.SAFManager.DOCUMENT_AUTHORITY;
...
public final class DocumentsContract {
     ...
     */
    public static final String PROVIDER_INTERFACE = "com.Devlex.iWifiFileTransfer.action.DOCUMENTS_PROVIDER";
    ...
    public final static class Document {
         ...
         *
         * @see #COLUMN_FLAGS
         * @see DocumentsContract#getDocumentThumbnail(ContentResolver, Uri, Point)
         * @see DocumentsProvider#openDocumentThumbnail(String)
         */
         ...
         * @see #COLUMN_FLAGS
         * @see #COLUMN_MIME_TYPE
         * @see DocumentsProvider#openTypedDocument()
         ...
         * @see DocumentsProvider#removeDocument()
         */
         ...
         *
         * @see #COLUMN_FLAGS
         * @see DocumentsProvider#queryChildDocuments(String, String[])
         * @hide
         */
     ...
     * {@link com.Devlex.iWifiFileTransfer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID}.
     *
    ...
    /**
     * Build URI representing the target {@link com.Devlex.iWifiFileTransfer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} in
     * a document provider. When queried, a provider will return a single row
     * with columns defined by {@link com.Devlex.iWifiFileTransfer.model.DocumentsContract.Document}.
     *
     ...
     * Build URI representing the children of the target directory in a document
     * provider. When queried, a provider will return zero or more rows with
     * columns defined by {@link com.Devlex.iWifiFileTransfer.model.DocumentsContract.Document}.
     * <p>
     ...
     *            directory with MIME type of {@link com.Devlex.iWifiFileTransfer.model.DocumentsContract.Document#MIME_TYPE_DIR}.
     * @see android.content.Intent#ACTION_OPEN_DOCUMENT_TREE
     * @see android.provider.DocumentsProvider#isChildDocument(String, String)
    ...
    /**
     * Extract the {@link com.Devlex.iWifiFileTransfer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     *
    ...
    /**
     * Extract the via {@link com.Devlex.iWifiFileTransfer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     */
