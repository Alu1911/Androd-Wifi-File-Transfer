...
import static com.Devlex.iWifiFileTransfer.model.DocumentsContract.METHOD_COMPRESS_DOCUMENT;
import static com.Devlex.iWifiFileTransfer.model.DocumentsContract.METHOD_COPY_DOCUMENT;
import static com.Devlex.iWifiFileTransfer.model.DocumentsContract.METHOD_CREATE_DOCUMENT;
import static com.Devlex.iWifiFileTransfer.model.DocumentsContract.METHOD_DELETE_DOCUMENT;
import static com.Devlex.iWifiFileTransfer.model.DocumentsContract.METHOD_IS_CHILD_DOCUMENT;
import static com.Devlex.iWifiFileTransfer.model.DocumentsContract.METHOD_MOVE_DOCUMENT;
import static com.Devlex.iWifiFileTransfer.model.DocumentsContract.METHOD_REMOVE_DOCUMENT;
import static com.Devlex.iWifiFileTransfer.model.DocumentsContract.METHOD_RENAME_DOCUMENT;
import static com.Devlex.iWifiFileTransfer.model.DocumentsContract.METHOD_UNCOMPRESS_DOCUMENT;
import static com.Devlex.iWifiFileTransfer.model.DocumentsContract.buildDocumentUri;
import static com.Devlex.iWifiFileTransfer.model.DocumentsContract.buildDocumentUriMaybeUsingTree;
import static com.Devlex.iWifiFileTransfer.model.DocumentsContract.buildTreeDocumentUri;
import static com.Devlex.iWifiFileTransfer.model.DocumentsContract.getDocumentId;
import static com.Devlex.iWifiFileTransfer.model.DocumentsContract.getRootId;
import static com.Devlex.iWifiFileTransfer.model.DocumentsContract.getSearchDocumentsQuery;
import static com.Devlex.iWifiFileTransfer.model.DocumentsContract.getTreeDocumentId;
import static com.Devlex.iWifiFileTransfer.model.DocumentsContract.isTreeUri;
 ...
 * {@link #queryChildDocuments(String, String[])}. For example, a
...
*/
    ...
    public abstract ParcelFileDescriptor openDocument(
            String documentId, String mode) throws FileNotFoundException;
     ...
     * @see #queryChildDocuments(String, String[])
            ...
            switch (mMatcher.match(uri)) {
                ...
                case MATCH_CHILDREN_TREE:
                    ...
                    if (DocumentsContract.isManageMode(uri)) {
                        ...
                        return queryChildDocuments(getDocumentId(uri), projection);
                    }
                default:
    ...
    private Bundle callUnchecked(String method, Bundle extras)
            throws FileNotFoundException {
     ...
     * Implementation is provided by the parent class. Cannot be overriden.
     *
     * @see #openDocument(String, String)
     */
    @Override
    public final ParcelFileDescriptor openFile(Uri uri, String mode) throws FileNotFoundException {
        enforceTree(uri);
        return openDocument(getDocumentId(uri), mode);
    }
     ...
     * Implementation is provided by the parent class. Cannot be overriden.
     *
     * @see #openDocumentThumbnail(String)
     */
    @Override
    public final AssetFileDescriptor openAssetFile(Uri uri, String mode)
            throws FileNotFoundException {
        enforceTree(uri);
        final ParcelFileDescriptor fd = openDocument(getDocumentId(uri), mode);
    ...
    private final AssetFileDescriptor openTypedAssetFileImpl(
        ...
        if (opts != null && opts.containsKey(ContentResolver.EXTRA_SIZE)) {
            ...
            return openDocumentThumbnail(documentId);
        }
    ...
    private int enforceReadPermission()
        ...
        final int mode = enforceReadPermissionInner();
    ...
    private int enforceWritePermission()
            throws SecurityException {
    ...
    protected int enforceReadPermissionInner()
            throws SecurityException {
        return MODE_ALLOWED;
    }

    protected int enforceWritePermissionInner()
            throws SecurityException {
        return MODE_ALLOWED;
    }
