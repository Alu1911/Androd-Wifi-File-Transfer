...
import com.Devlex.iWifiFileTransfer.model.DocumentsContract.Root;
 import com.Devlex.iWifiFileTransfer.root.RootCommands;
import com.Devlex.iWifiFileTransfer.root.RootFile;
...
/*        if (file.isDirectory() && null != file.list()) {
    ...
    public Cursor queryChildDocuments(
        ...
        final MatrixCursor result = new DirectoryCursor(
                resolveDocumentProjection(projection), parentDocumentId);
        try {
...
//        final ContentResolver resolver = getContext().getContentResolver();
    ...
    private class DirectoryCursor extends MatrixCursor {
        ...
        public DirectoryCursor(String[] columnNames, String docId) {
            super(columnNames);
